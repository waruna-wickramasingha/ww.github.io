...
thumbnail: /images/lru_cache.jpg
---
...
1- When the arguements are **Unhashable**. <br>
lru_cache requires the funtion's input parameters to be hashable and it would give errors otherwise. 
Examples for hashable data types are `tuple`, `string`, `numbers(int, float)`, `bool`, `frozensets`, `NoneType`
...
3- Function using/returning time sensitive data.<br>
...
4- Functions with large return values. <br>
